...
public class Move : MonoBehaviour
{
    ...
    void Update(){
        if (player.currentAction == Player.Action.DEAD) return;
        ...
        if (player.currentAction != Player.Action.Casting) player.baseSkills[2].Detect();
    ...
    void FixedUpdate(){
        ...
        else if(player.currentAction == Player.Action.Attacking) player.baseSkills[2].Cast();
...
/*------------------------------------------------------------------------------*/
    ...
    void UpdateTimers(){
        ...
        foreach(BaseModule skill in player.baseSkills) skill.UpdateTimer();
    }
}
